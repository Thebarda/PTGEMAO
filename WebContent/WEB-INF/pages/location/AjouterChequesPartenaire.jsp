...
<form method="post" action="#" class="offset">
	<fieldset>
		...
		<label>Numéro de cheque *: </label><input type="text" name="numero" required="required"><br>
		<label>Montant de chèque *: </label><input type="text" name="montant" required="required"><br>
		<label>Date d'encaissement *: </label><input type="text" name="dateEncaissement" required="required" class="datepicker"><br>
