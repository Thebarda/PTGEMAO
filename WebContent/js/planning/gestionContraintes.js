...
(function() {
  ...
  $(document).ready(function() {
    ...
    ajouterDansTableauJSON = function() {
      var bool, contrainteJSON, heureDebContrainte, heureFinContrainte, idJour, idSalle, isGlobale, messageContrainte, minuteDebContrainte, minuteFinContrainte;
    ...
    mettreAJourPhrases = function() {
      var hDebC, hFinC, isGlobale, jour, mDebC, mFinC, message, phrase;
