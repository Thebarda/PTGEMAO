...
public class Pattern {
	public final static String
		...
		LOCATION_CHEQUE_LISTER = MODULE_LOCATION + "/listerChequesLocation", 
		LOCATION_CHEQUE_AJOUTER = MODULE_LOCATION + DROIT_ECRITURE + "/ajouterChequeLocation", 
		LOCATION_CHEQUE_SUPPRIMER = MODULE_LOCATION + DROIT_ECRITURE + "/supprimerChequeLocation",
		LOCATION_CHEQUE_DEE = MODULE_LOCATION + DROIT_ECRITURE + "/ChequeDEE",
		LOCATION_DETAILS = MODULE_LOCATION + "/affcherDetailsLocation",
		
		ARCHIVAGE_LISTER = MODULE_ARCHIVAGE + DROIT_ECRITURE + "/ListerRepsFichiers",
		
		COMPTABILITE_ENSEIGNEMENT = MODULE_COMPTABILITE_ENSEIGNEMENT + DROIT_ECRITURE + "/ComptabiliteEnseignement",
		COMPTABILITE_LISTER_CHEQUES = MODULE_COMPTABILITE_ENSEIGNEMENT + DROIT_ECRITURE + "/listerCheques",
		COMPTABILITE_AJOUTER_CHEQUES = MODULE_COMPTABILITE_ENSEIGNEMENT + DROIT_ECRITURE + "/AjouterChequePartenaire",
		COMPTABILITE_AJOUTER_PARTENAIRE = MODULE_COMPTABILITE_ENSEIGNEMENT + DROIT_ECRITURE + "/AjouterPartenaire",
		COMPTABILITE_LISTER_PARTENAIRES = MODULE_COMPTABILITE_ENSEIGNEMENT + "/ListerPartenaires",
		COMPTABILITE_DETAILS_PARTENAIRE = MODULE_COMPTABILITE_ENSEIGNEMENT + DROIT_ECRITURE + "/AfficherDetailsPartenaire",
