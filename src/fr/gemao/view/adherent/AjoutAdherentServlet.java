...
public class AjoutAdherentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(FamilleCtrl.getNbElevesByNomFamille(famille)==5){
			request.setAttribute("isFamilleFull", true);
			response.sendRedirect(request.getContextPath() + Pattern.ADHERENT_SAISIE_COTISATION);
		}else if(FamilleCtrl.getNbElevesByNomFamille(famille)<5){
			/**
